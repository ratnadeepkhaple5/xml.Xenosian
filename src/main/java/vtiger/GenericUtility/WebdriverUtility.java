...
public class WebdriverUtility {
	...
	/**
	 * This method will wait until 'element' to be visible
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * this method will handle drop-down by using select class based on Index
	 * @param element
	 * @param index
	 */
	...
	/**
	 * to left click on element using mousePress and mouseRelease
	 * @throws AWTException
	 */
	public  void leftClickRobot() throws AWTException {
		Robot robot=new Robot();
	...
	//TakesSceenshot
	/**
	 * this will take ScreenShot and save in screenshots folder
	 * @param driver
	...
	/**
	 * This method will 'send text on disabled text field'
	 */
	public void sendTextOnDisabledField(WebDriver driver,WebElement element,String textvalue) {
		JavascriptExecutor jse=(JavascriptExecutor)driver;
		jse.executeScript("arguments[0].value='"+textvalue+"'", element);
	}
	/**
	 * to set alert popup using JSE
	 */
	public void setAlertPopupOnWindow(WebDriver driver,String alertText) {
		JavascriptExecutor jse=(JavascriptExecutor)driver;
		jse.executeScript("window.alert('"+alertText+"')");
	}
}
